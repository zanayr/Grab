...
(function () {
    ...
    //  AUX FUNCTIONS  -------------------------------------------------------  AUX  //
    //  The following section has the auxilary functions for the grab library
    function _getID (i) {
    ...
    //  _isNumber should return true or false if the passed parameter is a number
    ...
    //  The _parse function should take a passed dom object, property and value, and
